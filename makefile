...
WEB_EXPORTED_CHIP8_FUNCTIONS = '["_web_load_rom_chip8","_web_reset_chip8","_web_toggle_pause_chip8","_malloc","_free"]'
...
web:
	...
	-sEXPORTED_FUNCTIONS=$(WEB_EXPORTED_CHIP8_FUNCTIONS) -sEXPORTED_RUNTIME_METHODS=$(WEB_EXPORTED_RUNTIME_METHODS) -sEXPORT_ES6=1 -sMODULARIZE=1 -sUSE_SDL=3 --emit-tsd chip8.d.ts
